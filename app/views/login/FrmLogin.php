...
<div id="box01" class="login-box animated flipInY">
    ...
    <div  class="login-box-body">
        ...
        <div class="form-group has-feedback">
            <input id="textUser" type="text" class="form-control" placeholder="Correo">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            <input id="textPass" type="password" class="form-control" placeholder="Contraseña">
        ...
        <div class="row row-sm">
            ...
            <div class="col-md-6"><span id="btnBoxRegister" class="small waves pull-right btn btn-link btn-xs"><i></i> Registrarse</span></div>
        </div>
        <div class="row row-sm">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-control-sm">
                            ...
                            <input title="Nombre de la empresa" maxlength="45" type="text" required="required" class="form-control input-sm" placeholder="Nombre de la Empresa">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group form-control-sm">
                            ...
                            <input title="Teléfono de la empresa" data-inputmask='"mask": "(99) 9999-9999"' data-mask class="form-control input-sm" placeholder="Teléfono de la Empresa">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-control-sm">
                            <label class="small">Otro Teléfono</label>
                            <input title="Otro Teléfono" data-inputmask='"mask": "(99) 9999-9999"' data-mask  class="form-control input-sm" placeholder="Otro Teléfono">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group form-control-sm">
                            <label class="small">Celular</label>
                            <input title="Celular de la empresa" data-inputmask='"mask": "99 9999-9999"' data-mask   class="form-control input-sm" placeholder="Celular de la Empresa">
                        </div>
                    </div>
